...
export class AddressFormComponent implements OnInit {
   ...
   address: Address = new Address(0, null, '', '', null, '', '');  // inicializiramo address objekt
  ...
  saveRecords() {
    ...
    const payload = {
      building_num: this.address.building_num ?? 0,
      street: this.address.street,
      house_num: this.address.house_num,
      post_num: this.address.post_num ?? 0, 
  ...
  public clearForm(): void {     // public, zato, ker jo kličemo tudi iz html, privatne lahko kličem samo v istem fajlu!
    this.address = new Address(0, null, '', '', null, '', '');
  }
